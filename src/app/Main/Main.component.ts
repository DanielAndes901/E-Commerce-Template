...
export class MainComponent implements OnInit {
   ...
   constructor(private loader : LoadingBarService,
      ...
      title.setTitle('ECTEMPLATE - Angular 10 Material Design eCommerce Template');
      ...
      meta.addTags([
         ...
         { name: 'description', content: 'ECTEMPLATE is an E-Commerce angular 10 based template with material design. It also comes with Angular cli. Now you have all the power to maintain your ecommerce site. Responsive design gives your user to use in any modern devices. Clean Code gives you the power to customize the code as per as your requirments. ECTEMPLATE has all the basics functionality which is required in ecommerce site. Rtl design makes the multi-language support with more easy way.' }
      ]);
